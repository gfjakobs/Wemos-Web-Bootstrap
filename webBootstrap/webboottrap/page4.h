...
<div class="container">
            <div class="container">
              <div class="row" >
                ...
                <div class="col-sm">
                  <table class="table table-borderless text-center">
                    <tr><td><a class="btn btn-dark disabled" href="/page4" role="button">Av</a></td></tr>
                    <tr><td><div class="spinner-border text-dark" role="status"> <span class="sr-only">Loading...</span></div></td></tr>
                  </table>
                </div>
          </div> 
