...
<div class="jumbotron text-center">
  ...
  <p>Geir sin bootstrap. Hvit Lys.</p> 
</div>
              ...
              <div class="row" >
                <div class="col-sm">
                  <table class="table table-borderless text-center">
                    <tr><td><a class="btn btn-primary disabled" href="/" role="button">Hvit</a></td></tr>
                    <tr><td><div class="spinner-border text-primary" role="status"> <span class="sr-only">Loading...</span></div></td></tr>
                  </table>                  
                </div>
