...
<div class="jumbotron text-center">
  ...
  <p>Geir sin bootstrap. Grønt Lys.</p> 
</div>
...
<div class="container">
            <div class="container">
              <div class="row" >
                ...
                <div class="col-sm">
                  <table class="table table-borderless text-center">
                    <tr><td><a class="btn btn-danger" href="/page2" role="button">Rød</a></td></tr>
                    <tr><td></td></tr>
                  </table>
                </div>
                ...
                <div class="col-sm">
                  <table class="table table-borderless text-center">
                    <tr><td><a class="btn btn-success disabled" href="/page3" role="button">Grønn</a></td></tr>
                    <tr><td><div class="spinner-border text-success" role="status"> <span class="sr-only">Loading...</span></div></td></tr>
                  </table>
                </div>
